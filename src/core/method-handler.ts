...
export interface MethodHandler<TMethod extends string, TContext = {}, TRoutes = {}> {
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, []>>>;
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1]>>>;
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2]>>>;
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3]>>>;
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3, TM4]>>>;
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3, TM4, TM5]>>>;
    ...
    ): Drift<TContext, TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3, TM4, TM5, TM6]>>>;
    ...
    >(
        ...
        TContext,
        TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3, TM4, TM5, TM6, TM7]>>
    >;
    ...
    >(
        ...
        TContext,
        TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3, TM4, TM5, TM6, TM7, TM8]>>
    >;
    ...
    >(
        ...
        TContext,
        TRoutes & Unwrap<DriftRoute<TContext, TPath, TMethod, TData, [TM1, TM2, TM3, TM4, TM5, TM6, TM7, TM8, TM9]>>
    >;
}
